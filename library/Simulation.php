...
class Simulation{
	/**
	 * 
	 * „истка базы при старте моделировани€
	 * @param string $date
	 * @return bool
	 */
	...
	/**
	 * 
	 * ѕолучение кол-ва материалов, необходимых дл€  пр-ва товаров
	...
	/**
	 * 
	 * ѕолучение кол-ва товаров в плане начинаю с date до date+time
	 * @param int $date
	 * @param int $time
	 * @return mixed
	 */
